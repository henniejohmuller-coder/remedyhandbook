          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('CSV Format', style: AppTextStyles.heading3),
                ...
                Wrap(spacing: 8, runSpacing: 8, children: [
                  _SmallButton(
                    icon: Icons.download,
                    label: kIsWeb ? 'Download template' : 'Save template',
                    onTap: _downloadTemplate,
                  ),
                  _SmallButton(
                    icon: _dbDownloading ? Icons.hourglass_top : Icons.cloud_download_outlined,
                    label: _dbDownloading ? 'Exporting…' : (kIsWeb ? 'Download database' : 'Export database'),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: _parsed ? Colors.green : Colors.grey.shade300,
                    width: 2,
                  ),
                ...
                child: Column(children: [
                  Icon(
                    _parsed ? Icons.check_circle : Icons.upload_file,
                    size: 40,
                    color: _parsed ? Colors.green : AppColors.textSecondary,
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _parsed ? Colors.green : AppColors.dark,
                    ),
                  ),
                  if (_parsed)
                    Text('${_rows.length} remedies ready',
                        style: AppTextStyles.caption),
                ]),
              ),
            ),
